...
public class CobrarObispo extends Behaviour {
	...
	public void action() {
		 ...
		 */
		MessageTemplate filtroIdentificador = MessageTemplate.MatchOntology(agt.getOnto().COBRARDISTRITOSOBISPO);
		...
		if(msg!=null){
			...
			CobrarDistritosObispo mt=(CobrarDistritosObispo)contenido;
